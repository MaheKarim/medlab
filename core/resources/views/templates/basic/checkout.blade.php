...
@section('content')
    <div class="cart-section bg-white">
            ...
            <div class="container">
                <form id="checkout-form" action="{{ route('user.checkout.order') }}" method="POST">
                    ...
                    <div class="row gy-4 gy-4">
                        <div class="col-lg-7">
                            <div class="checkout-wrapper order-summary card custom--card">
                                <div class="card-header">
                                    <h6 class="card-title">@lang('Billing details')</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                        ...
                        <div class="col-lg-5">
                            <div class="order-summary card custom--card">
                                <div class="card-header">
                                    <h6 class="card-title">@lang('Order detail')</h6>
                                </div>
                               <div class="card-body">
                                ...
                                <div class="payment-methods">
                                    <h6 class="border-bottom py-3">@lang('Payment methods')

                                    </h6>
                                    <div class="payment-methods d-flex flex-wrap mt-3" style="gap:10px">
                                        <div class="d-flex flex-wrap w-100" style="gap:25px">
                                            <div class="form--radio flex-grow-1">
