                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            <a href="{{ route('admin.order.details', $order->id) }}" class="btn btn-sm btn-outline--primary">
                                            ...
                                            @if ($order->order_status == Status::ORDER_PENDING)
                                                <button class="btn btn-sm btn-outline--danger cancelOrderModal" data-url="{{ route('admin.order.status', $order->id) }}">
        ...
        (function($) {
            ...
            $('.orderStatusModal').on('click', function() {
                ...
                if (orderStatus == 0) {
                    ...
                    modal.find('.modal-detail').text(`@lang('Are you sure to confirm this delivery?')`);
                    status = 3;
                }
